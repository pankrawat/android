package com.app.baccoon.recycle;
...
public class HomeGridAdapter extends BaseAdapter {
    ...
    public HomeGridAdapter(Context context, ArrayList<ProductBean> m) {
    ...
    public View getView(final int groupPosition, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflator.inflate(R.layout.home_grid_item, null);
